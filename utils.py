...
def calculate_cate_loss(pred_cate, gold_cate):
    return F.cross_entropy(pred_cate, gold_cate.long(), size_average=False, ignore_index=-1)
            ...
            if temp_seq[idx] == 1:
                ...
                if len(start_index) != 0:
                    ...
                    for index in start_index:
                        if max_prob <= start_prob[start.index(index)]:
